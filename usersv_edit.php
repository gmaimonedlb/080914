                            ...
                            <form role="form" id="cuser" name="cuser" action="#" method="POST" enctype="multipart/form-data">
                                ...
                                <div class="box-body">
                                    <div class="input-group">
                                        ...
                                        <input type="text" class="form-control" placeholder="Nombre" id="f_name" name="f_name" value="<?php echo $user->f_name?>">
                                    </div>
                                    <br/>
                                    <div class="input-group">
                                        <span class="input-group-addon"><i class="glyphicon glyphicon-user"></i></span>
                                        <input type="text" class="form-control" placeholder="Apellido" id="l_name" name="l_name" value="<?php echo $user->l_name?>">
                                    </div>
                                    <br/>
                                    <div class="input-group">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <img alt="User Image" class="img-circle" src="<?php echo $user_image_route.$user->image?>">
                                    </div>
                                    <div class="form-group">
